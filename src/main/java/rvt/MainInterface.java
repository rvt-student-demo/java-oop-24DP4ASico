...
public class MainInterface {
    ...
    box1.add(new Book("Fyodor Dostoevsky", "Crime and Punishment", 4)) ;
    box1.add(new Book("Robert Martin", "Clean Code", 2));
    box1.add(new Book("Kent Beck", "Test Driven Development", 1.4));
    ...
    box2.add(new Book("Fyodor Dostoevsky", "Crime and Punishment", 20)) ;
    box2.add(new Book("Robert Martin", "Clean Code", 3));
    box2.add(new Book("Kent Beck", "Test Driven Development", 40.7));
